...
class ManutencaoResource {
    ...
    @Autowired
    private lateinit var service: ManutencaoService
    ...
    fun insert(@Valid @RequestBody objDTO: ManutencaoDTO): ResponseEntity<Unit> {
    ...
    fun update(@Valid @RequestBody objDTO: ManutencaoDTO,
